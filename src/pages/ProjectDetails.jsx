          ...
          <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/[0.025] shadow-2xl backdrop-blur-xl">
            ...
            <div className="p-6 md:p-10">
              ...
              <div className="mb-10 grid gap-5 md:grid-cols-2">
                ...
                {/* Challenges */}
                <Reveal delay={0.05}>
                  <div className="h-full group rounded-2xl border border-white/10 bg-white/[0.02] p-6 transition-all duration-300 hover:border-orange-400/20 hover:bg-orange-400/[0.02]">
                    <div className="mb-4 flex items-center gap-3">
                ...
                {/* Future Plans */}
                <Reveal delay={0.1}>
                  <div className="h-full group rounded-2xl border border-white/10 bg-white/[0.02] p-6 transition-all duration-300 hover:border-purple-400/20 hover:bg-purple-400/[0.02]">
                    <div className="mb-4 flex items-center gap-3">
